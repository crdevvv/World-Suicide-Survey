...
* il risultato conferma l'ipotesi in quanto c'è una forte correlazione (0.880) fra il *gdp pro capite* e lo scorrere     gli *anni*,che presuppongono lo sviluppo economico di ogni stato.
...
```
* con un **R^2** pari a *0.3* questo modello è abbastanza affidabile e ha un mediocre potere predittivo per quanto riguarda la variabile risposta *suicidi_per_100k* rispetto alla variabile esplicativa *sex*.
